...
class Settings:
    def __init__(self):
        ...
        self.allowed_origins: str = os.getenv("ALLOWED_ORIGINS", "http://localhost:5173,http://127.0.0.1:5173,http://localhost:3000,http://127.0.0.1:3000,https://answerdoctor.vercel.app,https://answerdoctor-jsbrxv8kg-trps-urgewave.vercel.app")
